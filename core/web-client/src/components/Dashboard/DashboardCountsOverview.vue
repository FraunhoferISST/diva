<template>
  <v-container fluid>
    <v-row>
      ...
      <!--      <v-col cols="12" md="12" lg="4" class="mt-12 mt-lg-0">
        <card class="pt-16 px-16 pb-16 pb-lg-0">
          <template slot="body">
            <v-row>
              <v-col>
                <h4 class="dashboard-count-title">Users</h4>
                <count-up class="dashboard-count" :end-val="usersCount" />
              </v-col>
            </v-row>
          </template>
        </card>
