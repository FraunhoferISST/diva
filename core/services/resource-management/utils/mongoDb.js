...
const mongoDbName = process.env.MONGO_DB_NAME || "resourcesDb";
const mongoCollectionName = process.env.MONGO_COLLECTION_NAME || "resources";
...
const mongoDb = {
  async connect() {
    ...
    this.resourceCollection = this.database.collection(mongoCollectionName);
